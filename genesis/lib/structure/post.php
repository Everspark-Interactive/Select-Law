...
function genesis_get_author_box( $context = '' ) {
    ...
    // Get the author's display name and the URL to the author archive page
    $author_name = get_the_author_meta( 'display_name', $user_id );
    $author_link = get_author_posts_url( $user_id );

    // Generate clickable author link
    $author_markup = '<a href="' . esc_url( $author_link ) . '" class="author-link">' . esc_html( $author_name ) . '</a>';

    // Return the author markup
